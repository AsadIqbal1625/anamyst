...
export default function RootLayout({ children }) {
  return (
    <html lang="en" data-scroll-behavior="smooth">
      ...
      >
        <div className="group flex items-center gap-3 bg-black/80 backdrop-blur-xl border border-[#D4AF37]/30 hover:border-[#D4AF37] px-4 md:px-5 py-3 md:py-4 rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105">

          {/* ICON */}

          <div className="bg-green-500 rounded-full w-11 h-11 md:w-12 md:h-12 flex items-center justify-center shrink-0">
          ...
          <div className="block">
            ...
            <p className="text-[10px] md:text-xs uppercase tracking-[2px] md:tracking-[3px] text-[#D4AF37]">
